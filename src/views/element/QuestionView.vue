    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item>
            <el-button type="primary" @click="onSubmit">查询题目</el-button>
          </el-form-item>
...
export default {
  data() {
   ...
   {
          id: "1",
          question: "德国的首都是哪一座城市呢?",
          options: "柏林, 柏林, 柏林, 柏林",
          answer: "柏林",
        },
        {
          id: "2",
          question: "英国的首都是哪一座城市呢?",
          options: "伦敦, 伦敦, 伦敦, 伦敦",
          answer: "伦敦",
        },
        {
          id: "3",
          question: "日本的首都是哪一座城市呢?",
          options: "东京, 东京, 东京, 东京",
          answer: "东京",
        },
        {
          id: "4",
          question: "俄国的首都是哪一座城市呢?",
          options: "莫斯科, 莫斯科, 莫斯科, 莫斯科",
          answer: "莫斯科",
        },
      ],
    };
...
<style>
/* 减小el-form-item的默认垂直间距 */
.el-form-item {
  margin-bottom: 10px; /* 将默认的较大间距改为10px */
}
